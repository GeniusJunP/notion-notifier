...
## Coverage
- total functions: 245
- go functions (including tests): 200
- frontend functions (ts+svelte): 44
- script functions: 1
- edge rule: static same-group call references (body-scoped for frontend/scripts, AST-scoped for Go).
...
flowchart TD
  ...
  n23["internal/http/api/helpers.go:respondError"]
  n24["internal/http/api/helpers.go:respondJSON"]
  n25["internal/http/api/helpers.go:respondValidationError"]
  n26["internal/http/api/timeutil.go:formatDurationShort"]
  n27["internal/http/api/timeutil.go:loadLocationOrLocal"]
  n28["internal/http/api/timeutil.go:parseDateInput"]
  n29["internal/http/api/timeutil.go:parseDateRange"]
  n2 --> n24
  n3 --> n23
  n4 --> n23
  n4 --> n24
...
flowchart TD
  ...
  n27["internal/scheduler/worker.go:(Scheduler).schedulePendingFromDB"]
  n28["internal/scheduler/worker.go:(Scheduler).sendPeriodic"]
  n29["internal/scheduler/worker.go:(Scheduler).sendWebhook"]
  n30["internal/scheduler/worker.go:(Scheduler).syncCalendar"]
  n31["internal/scheduler/worker.go:(Scheduler).syncLoop"]
  n32["internal/scheduler/worker.go:(Scheduler).syncNotion"]
  n33["internal/scheduler/worker.go:New"]
  n34["internal/scheduler/worker.go:buildAdvanceSchedules"]
  n35["internal/scheduler/worker.go:buildFilterValues"]
  n36["internal/scheduler/worker.go:buildTemplateEvents"]
  n37["internal/scheduler/worker.go:extractCustomValues"]
  n38["internal/scheduler/worker.go:groupCalendarEvents"]
  n39["internal/scheduler/worker.go:matchAdvanceConditions"]
  n40["internal/scheduler/worker.go:matchFilter"]
  n41["internal/scheduler/worker.go:matchesDays"]
  n42["internal/scheduler/worker.go:notionOnOrAfterDate"]
  n43["internal/scheduler/worker.go:parseEventStart"]
  n44["internal/scheduler/worker.go:pickPrimaryCalendarEvent"]
  n45["internal/scheduler/worker.go:scheduleKey"]
  n46["internal/scheduler/worker.go:toTemplateEvent"]
  n47["internal/scheduler/worker.go:weekdayToConfig"]
  n48["internal/scheduler/worker_test.go:TestMatchAdvanceConditions"]
  n49["internal/scheduler/worker_test.go:TestMatchesDays"]
  n50["internal/scheduler/worker_test.go:TestNotionOnOrAfterDate_JSTEarlyMorningUsesPreviousUTCDate"]
  n51["internal/scheduler/worker_test.go:TestNotionOnOrAfterDate_PSTUsesSameUTCDate"]
  n52["internal/scheduler/worker_test.go:TestSendWebhookRecordsHistoryOnPayloadRenderError"]
  n53["internal/scheduler/worker_test.go:TestToTemplateEvent_MapsEndDateAndTime"]
  n3 --> n19
  n6 --> n8
  n11 --> n6
  n12 --> n37
